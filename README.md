...
# Notes for Usage:
You will probably have to go in and uncomment some of the functions in the strategies section of the code, all strategies up until fireworks have been coded and proved to function properly.
